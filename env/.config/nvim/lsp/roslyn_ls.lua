...
local roslny_bin =
  vim.fn.expand '$HOME/.nuget/packages/microsoft.codeanalysis.languageserver.osx-arm64/5.3.0-1.25516.1/content/LanguageServer/osx-arm64/Microsoft.CodeAnalysis.LanguageServer.dll'
...
local function roslyn_handlers()
  return {
    ...
    ['razor/provideDynamicFileInfo'] = function(_, _, _)
      vim.notify('Razor is not supported.\nPlease use https://github.com/tris203/rzls.nvim', vim.log.levels.WARN, { title = 'roslyn_ls' })
      return vim.NIL
    end,
  }
end
